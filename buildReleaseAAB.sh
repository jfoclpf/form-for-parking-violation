...
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore autocosts.keystore -storepass $PASS app.aab autocosts

cd ../../../../../../..
rm formParkingViolation.aab

cp platforms/android/app/build/outputs/bundle/release/app.aab ./formParkingViolation.aab  
